...
public class CVDetector extends OpenCvPipeline {
    ...
    protected void drawContours(List<MatOfPoint> contours, Scalar scalar) {
        Imgproc.drawContours(displayMat, contours, -1, scalar, 1);
    }

    protected void drawCenterPoint(Point point, Scalar scalar) {
        Imgproc.circle(displayMat, point, 2, scalar);
    }
