...
public class MidnightColorSensor implements MidnightHardware {
    ...
    public void setActiveMode() {
        colorSensorManager.write8(COMMAND_REGISTER, ACTIVE_MODE_COMMAND);
    }

    public void setPassiveMode() {
        colorSensorManager.write8(COMMAND_REGISTER, PASSIVE_MODE_COMMAND);
    }

    public int colorNumber() {
        return colorSensorManager.read8(COLOR_NUMBER_REGISTER);
    }

    public int red() {
        return colorSensorManager.read8(RED_VALUE_REGISTER);
    }

    public int green() {
        return colorSensorManager.read8(GREEN_VALUE_REGISTER);
    }

    public int blue() {
        return colorSensorManager.read8(BLUE_VALUE_REGISTER);
    }

    public int alpha() {
        return colorSensorManager.read8(WHITE_VALUE_REGISTER);
    }
